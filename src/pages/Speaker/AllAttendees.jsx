    ...
    >
      ...
      <div className="bg-black grid gap-4 grid-cols-1 md:grid-cols-2 items-center">
        <div className="header-content mx-6 md:pl-12 py-6 ">
          ...
          Connect with a truly global and diverse audience at the World's Largest AI Summit, including visionary government officials, CEOs of leading AI companies, pioneering researchers from top institutions, and influential investors. You'll also meet the founders of groundbreaking AI startups and industry leaders implementing AI solutions across various sectors. This is your chance to network with the key players shaping the future of artificial intelligence.          </p>
