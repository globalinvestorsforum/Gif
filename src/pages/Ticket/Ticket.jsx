...
const TicketSection = () => {
  const tickets = [
    ...
    },
    {
      ...
      link: "https://pages.razorpay.com/pl_P3Kx7BsaShFz5M/view",
      buttonText: "Book Now",
      detailsText: "What's Included ↓",
      includes: [
  ...
  return (
    <section
      ref={containerRef}
      className=" py-12 px-4 lg:px-12 text-white bg-gradient-to-r from-purple-800 to-pink-800"
    ...
    >
      <div className=" header mx-auto px-4">
        ...
        <p className="text-center font-Antonio uppercase text-lg lg:text-3xl mb-12 text-transparent bg-gradient-to-r from-teal-400  via-yellow-400 to-red-400 bg-clip-text">
        ...
        <div className="pt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {tickets.map((ticket, index) => (
            <div key={index} className="ticket-card font-Archivo">
              <div className="bg-black/70 backdrop:blur-md shadow-lg p-6 rounded-lg flex flex-col text-center ">
                ...
                <Link
                  to={ticket.link ? ticket.link : "/gais/TicketRegistration"}
                  className="bg-gradient-to-r from-orange-500 to-purple-500 text-white py-2 px-4 rounded mt-4 hover:bg-yellow-500 duration-300 self-center"
                >
                  {ticket.buttonText}
                </Link>
                <button
                    ...
                    <ul className=" p-6 pl-8 pt-2 text-left">
                      {ticket.includes.map((item, itemIndex) => (
                        <div key={itemIndex} className="">
                          <li className="list-disc text-sm mt-1">{item}</li>
                        </div>
                      ))}
                    </ul>
                  </div>
