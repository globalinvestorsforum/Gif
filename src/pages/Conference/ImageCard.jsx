...
const ImageCard = ({ image, title, desc, eventLink }) => {
  ...
  return (
    ...
    <div 
    onClick={handleClick} // commemt to disable navigating to summit link
     className="border flex border-neutral-700 rounded-xl h-[250px] bg-gradient-to-r from-orange-700 to-purple-600 hover:border-white hover:shadow-md transition ease-in-out delay-150 hover:-translate-xy-2 hover:scale-105 duration-300 cursor-pointer">
